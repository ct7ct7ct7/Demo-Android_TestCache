...
import com.example.demo_android_test_cache.interceptors.NetworkCheckerApplicationInterceptor;
...
public class Example3Activity extends AppCompatActivity {
    ...
    private void initOkHttpClient() {
        ...
        cache = new Cache(Example3Activity.this.getExternalCacheDir(), CACHE_SIZE);
        okHttpClient = new OkHttpClient.Builder()
                .cache(cache)
                .addInterceptor(new NetworkCheckerApplicationInterceptor(this))
